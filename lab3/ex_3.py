...
def cat(x0, y0, length, width, day):
    '''
...
while not finished:
    ...
    cat(250, 360, 350, 200, day)
    knit(260, 515, 10, screen)
    cat(50, 550, 150, 105, day)

    knit(25, 25, 25, roll_knit)
    roll_knit.set_colorkey((0, 0, 0))
    screen.blit(pygame.transform.rotate(roll_knit, (-1)*counter_of_ticks * knit_speed), (counter_of_ticks * knit_speed, 600 - 50*sin(counter_of_ticks/3)))
